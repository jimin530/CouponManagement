...
public class UnusedCouponRVAdapter extends RecyclerView.Adapter<UnusedCouponRVAdapter.ViewHolder> {
    Context context;
    List<TBCoupon> tmpCouponList = new ArrayList<>();

    public UnusedCouponRVAdapter(Context context, List<TBCoupon> tmpCouponList) {
